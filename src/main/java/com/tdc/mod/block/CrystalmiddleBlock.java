...
public class CrystalmiddleBlock extends TdcModTtModElements.ModElement {
	@ObjectHolder("tdc_mod_tt:crystalmiddle")
	public static final Block block = null;
	public CrystalmiddleBlock(TdcModTtModElements instance) {
		super(instance, 1);
	}
