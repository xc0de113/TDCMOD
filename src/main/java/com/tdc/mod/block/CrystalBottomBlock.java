...
public class CrystalBottomBlock extends TdcModTtModElements.ModElement {
	@ObjectHolder("tdc_mod_tt:crystal_bottom")
	public static final Block block = null;
	public CrystalBottomBlock(TdcModTtModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystal_bottom");
		}
