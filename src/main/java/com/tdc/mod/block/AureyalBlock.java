...
public class AureyalBlock extends TdcModTtModElements.ModElement {
	@ObjectHolder("tdc_mod_tt:aureyal")
	public static final Block block = null;
	public AureyalBlock(TdcModTtModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).lightValue(0).notSolid());
			setRegistryName("aureyal");
		}
